...
#### SOLUTION
Conclusions: In this case, that is, when cut == "Ideal" and clarity == "IF".
...
Yes, the `displ` variable is "significant", because 0 is not contained within the confidence interval.
...
4 coefficients are displayed and they are all "significant" because 0 is not contained in their confidence interval.
